...
Read `CLAUDE.md` and `AGENTS.md` first. All work follows the fork's merge-friendly policy. Extension code remains the default; the small core API additions used by `/simple` are called out in the coupling watchlist.
