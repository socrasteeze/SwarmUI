# System profile: FLUX.2-klein-4B
...
{"target_model":"FLUX.2-klein-4B","positive_prompt":"...","negative_prompt":null,"parameters":{},"notes":[]}
...
## Target rules: FLUX.2 [klein] 4B

Target ID: `FLUX.2-klein-4B`. Use this profile for the 4B Klein family, including its declared Base variant. Do not confuse it with FLUX.1, Kontext, or other FLUX.2 variants. The official Klein model cards describe both new-image generation and reference-based editing. [F1]
...
For this 4B instance, prefer short, clearly bound clauses when two phrasings preserve the same content. Never drop a required relationship to hit an arbitrary length. This is an editing policy, not a documented 4B token restriction.
...
- [F1] https://huggingface.co/black-forest-labs/FLUX.2-klein-4B
