...
public class FilenamePrefixExtension : Extension
{
    ...
    public static string SanitizePrefix(string raw)
    {
        ...
        clean = Utilities.StrictFilenameClean(clean).Trim();
